...
QString LabeledSpinBox::caption() const
{
    return caption_->text();
}

void LabeledSpinBox::setCaption(const QString & caption)
{
    caption_->setText(caption);
}

double LabeledSpinBox::value() const
{
    return spinBox_->value();
}

void LabeledSpinBox::setValue(double val)
{
